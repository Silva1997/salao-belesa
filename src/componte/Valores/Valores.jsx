...
const Valores = () => {
    return (
        ...
        <div className=" landscape:w-[58vh] lg:w-[45vh] xs-min:w-[35vh] lg:h-[26rem] md:h-[21rem] xs-min:h-[19rem]  drop-shadow-lg p-2 flex flex-col items-center bg-gradient-to-l from-white from-[99%] to-[1%] to-orange-400 xl:w-[40vh] rounded-s-md xl:h-[17rem]">
          <img
            className="object-center  landscape:w-[40px] landscape:h-[40px] lg-min:w-[40px] lg:w-[40px] xs-min:w-[25px] md:w-[35px] md:h-[35px] xs-min:h-[25px] xl:w-[40px]  xl:h-[40px] p-0 m-0 rounded-[50%] "
            src={icon1}
            alt="Valor"
          />
        ...
        <div className=" md:h-[21rem]  landscape:w-[58vh]  lg:w-[45vh] lg:h-[26rem]  xs-min:w-[35vh] xs-min:h-[19rem]   drop-shadow-lg flex p-2 flex-col items-center bg-gradient-to-l from-yellow-950 to-slate-950 xl:w-[40vh] text-white  xl:h-[17rem]">
          <img
            className=" landscape:w-[40px] landscape:h-[40px]  lg-min:w-[40px] lg:w-[40px]  md:w-[35px] md:h-[35px]  xs-min:w-[25px] xs-min:h-[25px] object-center xl:w-[40px]  xl:h-[40px] pt-0 m-0 rounded-[50%] "
            src={icon3}
            alt="Valor"
          />
        ...
        <div className=" md:h-[21rem] landscape:w-[58vh] lg:w-[45vh] lg:h-[26rem]   xs-min:w-[35vh] xs-min:h-[19rem]   drop-shadow-lg flex flex-col p-2 items-center shadow-zinc-800 bg-gradient-to-r from-white from-[99%] to-[1%] to-orange-400 xl:w-[40vh] rounded-e-md xl:h-[17rem]">
          <img
            className=" landscape:w-[40px] landscape:h-[40px] lg-min:w-[40px] lg:w-[40px] md:w-[38px] md:h-[38px] 5 xs-min:h-[25px] object-center xl:w-[40px]  xl:h-[40px] pt-0 m-0 rounded-[50%] "
            src={icon2}
            alt="Valor"
          />
