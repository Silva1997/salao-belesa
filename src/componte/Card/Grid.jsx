...
const MyComponent = () => {
  ...
  return (
    <div
    id='controlar'
      className="md:pr-16 md:pl-16 overflow-hidden xs-min:Esconder md:mb-4 xs-min:pl-4 xs-min:pr-4 md:h-auto overflow-x-auto xs-min:s w-full pt-0 xs-min:h-auto h-auto xs-min:mb-4 xl:h-[33rem] xl:pl-28 xl:pr-28 scroll-smooth xs-min:scroll-smooth"
    >
      <div
        ref={scrolltrolador}
        onScroll={updateButton}
      ...
      >
        <div className="xs-min:rounded-md border-[2px] border-amber-200 bg-[url('https://i.imgur.com/vVv8PDR.png')] bg-cover bg-center bg-no-repeat -min:w-80 md:w-[30rem]  md:h-[30rem] xs-min:h-[20rem] xl:w-[60vh] xl:h-[27rem] bg-zinc-100">
          {/* 01 */}
        </div>
        <div className="xs-min:rounded-md border-[2px] border-amber-200 bg-[url('https://i.imgur.com/PzL4k1o.jpeg')] bg-cover bg-center bg-no-repeat md:w-[30rem] md:h-[30rem] xl:w-[60vh] xl:h-[27rem] bg-zinc-100">
          {/* 02 */}
        </div>
        <div className="xs-min:rounded-md border-[2px] border-amber-200 bg-[url('https://i.imgur.com/zn8GaXV.jpeg')] bg-cover bg-center bg-no-repeat md:w-[30rem] md:h-[30rem] xl:w-[60vh] xl:h-[27rem] bg-zinc-100">
          {/* 03 */}
        </div>
        <div className="xs-min:rounded-md border-[2px] border-amber-200 xl:w-[60vh] xl:h-[27rem] bg-zinc-100 md:w-[30rem] md:h-[30rem]">
          {/* 04 */}
        </div>
        <div className="xs-min:rounded-md border-[2px] border-amber-200 xl:w-[60vh] xl:h-[27rem] bg-zinc-100 md:w-[30rem] md:h-[30rem]">
          {/* 05 */}
