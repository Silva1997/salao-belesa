...
<div className="w-full  xs-min:max-h-auto xs-min:pl-4 xs-min:pr-4  md:h-auto  sm:h-auto    overflow-hidden pt-0  xl:h-[33rem] bg-zinc-80 xl:pl-28 xl:pr-28">
          ...
          {/*  */}
          <div className="grid sm:gap-2  sm:grid-cols-2 landscape:grid-rows-[90vh_90vh] sm:auto-cols-[200px]    md:gap-4 xs-min:gap-2  md:auto-cols-[200px]  md:grid-rows-[42vh_42vh] xs-min:grid-cols-2 md:grid-cols-2 xs-min:grid-rows-[35vh_35vh] xl:grid-rows-auto   xl:grid-cols-4 xl:auto-cols-[200px] xl:gap-4 pt-5 pb-5">
            <div className=" sm:h-[100%] md:h-[100%] md:bg-slate-400      border-b-2  border-orange-400   flex flex-col rounded-sm w-full xl:h-[27rem] xl:relative overflow-hidden group cursor-pointer">
            ...
            <div className=" sm:h-[100%]   md:h-[100%] md:bg-violet-400     flex flex-col  border-b-2 border-orange-400 rounded-sm w-full xl:h-[27rem] relative overflow-hidden group cursor-pointer">
              {/* <!-- Fundo do Card (Imagem) --> */}
              <img
                   src={unhas}
                alt="Imagem do Card"
            ...
            <div className=" sm:h-[100%]  md:h-[100%] md:bg-red-400      border-b-2 border-orange-400 flex flex-col  rounded-sm w-full xl:h-[27rem] relative overflow-hidden group cursor-pointer">
              {/* <!-- Fundo do Card (Imagem) --> */}
              <img
                src={unhas}
                alt="Imagem do Card"
            ...
            <div className=" sm:h-[100%]   md:h-[100%]    border-b-2 border-orange-400 flex flex-col rounded-sm w-full xl:h-[27rem] relative  overflow-hidden group cursor-pointer">
              {/* <!-- Fundo do Card (Imagem) --> */}
              <img
                src={makeup}
                alt="Imagem do Card"
