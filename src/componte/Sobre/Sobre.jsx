...
export default function Sobre() {
  return (
    <div>
      <div className="w-full  landscape:h-auto  xs-min:max-h-auto xs-min:pl-4 xs-min:pr-4  md:h-auto  sm:h-auto    overflow-hidden pt-0  xl:h-[33rem] bg-zinc-80 xl:pl-28 xl:pr-28">
        ...
        <div
          ...
          md:auto-cols-[200px]  md:grid-rows-1 xs-min:grid-cols-2 
          md:grid-cols-2 xs-min:grid-rows-[35vh_35vh] xl:grid-rows-auto   
          xl:grid-cols-4 xl:auto-cols-[200px] xl:gap-4 pt-5 pb-5"
        >
          <div className=" sm:max-h-[30rem] xl:h-[27rem]  md:h-[30rem] md:max-h-[30rem]   border-b-2  border-orange-400   flex flex-col rounded-sm w-full xl:bg-black  xl:relative overflow-hidden group cursor-pointer">
            {/* <!-- Fundo do Card (Imagem) --> */}

            <img
              src={cabelo}
              alt="Imagem do Card"
              className=" sm:w-full sm:object-fill sm:h-full xs-min:max-w-[100%] xs-min:max-h-[100%] md:h-[100%] md:object-center md:object-fill md:w-[100%] xs-min:object-cover xs-min:object-center xl:object-fill w-full xl:h-[27rem] xs-min:h-[100%] transform transition-transform duration-300 ease-in-out group-active:scale-110 group-hover:scale-105"
            />
          ...
          <div className=" sm:max-h-[30rem]  md:h-[30rem]   md:max-h-[30rem]     flex flex-col  border-b-2 border-orange-400 rounded-sm w-full xl:h-[27rem] relative overflow-hidden group cursor-pointer">
            {/* <!-- Fundo do Card (Imagem) --> */}
            <img
              src={unhas}
              alt="Imagem do Card"
              className=" sm:object-center  sm:w-full sm:object-fill sm:h-full md:object-center md:object-fill md-w-full xl:h-[27rem] xs-min:object-cover  xs-min:object-center  xl:object-fill xs-min:h-[100%] transform transition-transform duration-300 ease-in-out group-active:scale-110 group-hover:scale-105"
            />
          ...
          <div className=" sm:max-h-[30rem]  md:h-[30rem]  md: md:max-h-[30rem]      border-b-2 border-orange-400 flex flex-col  rounded-sm w-full xl:h-[27rem] relative overflow-hidden group cursor-pointer">
            {/* <!-- Fundo do Card (Imagem) --> */}
            <img
              src={unhas}
              alt="Imagem do Card"
