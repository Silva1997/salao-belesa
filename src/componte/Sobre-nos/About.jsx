        ...
        <div className="grid landscape:tablet:place-items-baseline     md:gap-1  md:pt-0 md:auto-rows-auto   place-items-center xs-min:auto-rows-auto grid-cols-2 auto-cols-auto xl:gap-8 xs-min:gap-4 ">
          ...
          <div className="  w-full xs-min:p-1  md:h-auto  xs-min:h-auto xl:h-[24rem]">
            <div className=" xl:top-0 xl:w-full xl:flex xl:flex-row xl:gap-1 xl:relative xl:z-0  xs-min:grid xs-min:grid-cols-1 xs-min:gap-6 xs-min:place-items-end sm:grid sm:grid-cols-1 sm:gap-6 sm:place-items-end md:grid md:grid-cols-1 md:gap-6 md:place-items-end landscape:tablet:grid landscape:tablet:grid-cols-1 landscape:tablet:gap-6 landscape:tablet:place-items-end ">
              ...
              <div className=" xl:shadow-2xl xs-min:w-40 xs-min:h-36 bg-no-repeat  bg-center bg-[url('./assets/icon1.jpg')] landscape:tablet:relative landscape:tablet:left-0  md:min-h-[12rem] xl:relative  rounded-md md:w-60 z-1 bg-cover xl:-top-6  xl:left-52 xl:max-w-full xl:w-[55rem]  xl:h-[11rem] bg-white">
                <h6 className="text-center xs-min:text-sm relative top-[-28px] text-black">
                  Fé
                </h6>
              </div>

              <div className=" xl:shadow-2xl  xs-min:w-40 xs-min:h-36 bg-no-repeat bg-cover bg-center bg-[url('./assets/icon2.png')]  md:min-h-[12rem]  xl:relative  rounded-md z-2 md:w-60  xl:top-[195px]  xl:left-8 right-[60px] xl:max-w-full xl:w-[55rem] xl:h-[12rem] bg-slate-500">
                <h6 className="text-center xs-min:text-sm xs-min:p-2 relative top-[-28px] text-black">
                  Foco
                </h6>
              </div>

              <div className=" xl:shadow-2xl xs-min:w-40 xs-min:h-36 bg-no-repeat bg-cover bg-center bg-[url('./assets/icon3.png')] md:min-h-[12rem]  xl:relative  rounded-md z-3 md:w-60  xl:top-20 xl:-left-0 right-20 xl:max-w-full xl:w-[58rem]  xl:h-[13rem] bg-neutral-500">
                <h6 className="text-center xs-min:text-sm xs-min:p-2  relative top-[-28px] text-black">
                  Trabalho
                </h6>
              </div>
